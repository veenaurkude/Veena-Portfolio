  ...
  return (
    <header className="bg-gray-900 md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
        ...
        <div className={`w-full md:flex md:items-center md:justify-between md:w-auto ${isNavOpen ? 'flex' : 'hidden'} flex-col md:flex-row`}>
          <nav className="md:flex md:items-center md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700 items-center text-base justify-center">
            <a href="#about" onClick={closeNav} className="mr-5 relative group">
              <span className="hover:text-white">About</span>
              <span className="block h-0.5 bg-white absolute bottom-0 left-0 w-full scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300 ease-out"></span>
            </a>
            <a href="#projects" onClick={closeNav} className="mr-5 relative group">
              <span className="hover:text-white">Projects</span>
              <span className="block h-0.5 bg-white absolute bottom-0 left-0 w-full scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300 ease-out"></span>
            </a>
            <a href="#skills" onClick={closeNav} className="mr-5 relative group">
              <span className="hover:text-white">Skills</span>
              <span className="block h-0.5 bg-white absolute bottom-0 left-0 w-full scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300 ease-out"></span>
            </a>
            <a href="#contact" onClick={closeNav} className="mr-5 relative group">
              <span className="hover:text-white">Contact</span>
              <span className="block h-0.5 bg-white absolute bottom-0 left-0 w-full scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300 ease-out"></span>
            </a>
          </nav>
